...
public class FileStatusMessage extends Message {
    ...
    public static FileStatusMessage result;
    ...
    public FileStatusMessage(final short p_destination) {
        super(p_destination, FileStatusMessage.MTYPE, FileStatusMessage.TAG);
        data = new byte[DxramFsConfig.max_pathlength_chars];
    }

    public FileStatusMessage(final short p_destination, final String p_data) {
        super(p_destination, FileStatusMessage.MTYPE, FileStatusMessage.TAG);
        gotResult = false;
    ...
    public static class InHandler implements MessageReceiver {
        ...
        public void onIncomingMessage(Message p_message) {
            result = (FileStatusMessage) p_message;
