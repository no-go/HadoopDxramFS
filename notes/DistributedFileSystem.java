...
public class DistributedFileSystem extends FileSystem {
  public static final Logger LOG = LoggerFactory.getLogger(DistributedFileSystem.class);
  ...
  public Path getWorkingDirectory() {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"()");
    return workingDir;
  }
  ...
  public void setWorkingDirectory(Path dir) {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", dir);
  ...
  String getPathName(Path file) {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", file);
    checkPath(file);
  ...
  public BlockLocation[] getFileBlockLocations(FileStatus file, long start,
	...
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {}, {})", file, start, len);
    if (file == null) {
      return null;
    }
  ...
  public BlockLocation[] getFileBlockLocations(Path p,
	...
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {}, {})", p, start, len);
  ...
  public BlockStorageLocation[] getFileBlockStorageLocations(
	...
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", blocks);
    return dfs.getBlockStorageLocations(blocks);
  }

  @Override
  public void setVerifyChecksum(boolean verifyChecksum) {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", verifyChecksum);
  ...
  public boolean recoverLease(final Path f) throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", f);
  ...
  public FSDataInputStream open(Path f, final int bufferSize)
      throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", f, bufferSize);
    statistics.incrementReadOps(1);
  ...
  public FSDataOutputStream append(Path f, final int bufferSize,
	...
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {}, {})", f, bufferSize, progress);
  ...
  public FSDataOutputStream append(Path f, final EnumSet<CreateFlag> flag,
	...
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {}, {}, {})", f, flag, bufferSize, progress);
  ...
  public FSDataOutputStream append(Path f, final EnumSet<CreateFlag> flag,
	...
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {}, {}, {}, {})", f, flag, bufferSize, progress, favoredNodes);
    statistics.incrementWriteOps(1);
    storageStatistics.incrementOpCounter(OpType.APPEND);
    Path absF = fixRelativePart(f);
    return new FileSystemLinkResolver<FSDataOutputStream>() {
  ...
  public FSDataOutputStream create(Path f, FsPermission permission,
	...
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {}, {}, {}, {}, {}, {})", f, permission, overwrite, bufferSize, replication, blockSize, progress);
  ...
  public HdfsDataOutputStream create(final Path f,
      ...
      throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {}, {}, {}, {}, {}, {}, {})", f, permission, overwrite, bufferSize, replication, blockSize, progress, favoredNodes);
    statistics.incrementWriteOps(1);
  ...
  public FSDataOutputStream create(final Path f, final FsPermission permission,
      ...
      throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {}, {}, {}, {}, {}, {}, {})", f, permission, cflags, bufferSize, replication, blockSize, progress, checksumOpt);
    statistics.incrementWriteOps(1);
    storageStatistics.incrementOpCounter(OpType.CREATE);
    Path absF = fixRelativePart(f);
    return new FileSystemLinkResolver<FSDataOutputStream>() {
  ...
  protected HdfsDataOutputStream primitiveCreate(Path f,
	...
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {}, {}, {}, {}, {}, {}, {})", f, absolutePermission, flag, bufferSize, replication, blockSize, progress, checksumOpt);
    statistics.incrementWriteOps(1);
  ...
  public FSDataOutputStream createNonRecursive(final Path f,
      ...
      final int bufferSize, final short replication, final long blockSize,
      final Progressable progress) throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {}, {}, {}, {}, {}, {})", f, permission, flag, bufferSize, replication, blockSize, progress);
    statistics.incrementWriteOps(1);
  ...
  public boolean setReplication(Path src, final short replication)
      throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", src, replication);
    statistics.incrementWriteOps(1);
  ...
  public void setStoragePolicy(final Path src, final String policyName)
      throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", src, policyName);
    statistics.incrementWriteOps(1);
  ...
  public void unsetStoragePolicy(final Path src)
      throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", src);
    statistics.incrementWriteOps(1);
    Path absF = fixRelativePart(src);
    new FileSystemLinkResolver<Void>() {
      @Override
  ...
  public BlockStoragePolicySpi getStoragePolicy(Path path) throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", path);
    statistics.incrementReadOps(1);
  ...
  public void concat(Path trg, Path [] psrcs) throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", trg, psrcs);
    statistics.incrementWriteOps(1);
  ...
  public boolean rename(Path src, Path dst) throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", src, dst);
    statistics.incrementWriteOps(1);
  ...
  public void rename(Path src, Path dst, final Options.Rename... options)
      throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {}, options)", src, dst);
    statistics.incrementWriteOps(1);
    storageStatistics.incrementOpCounter(OpType.RENAME);
    final Path absSrc = fixRelativePart(src);
    final Path absDst = fixRelativePart(dst);
  ...
  public boolean truncate(Path f, final long newLength) throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", f, newLength);
    statistics.incrementWriteOps(1);
  ...
  public boolean delete(Path f, final boolean recursive) throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", f, recursive);
    statistics.incrementWriteOps(1);
  ...
  public void setQuota(Path src, final long namespaceQuota,
	...
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {}, {})", src, namespaceQuota, storagespaceQuota);
    Path absF = fixRelativePart(src);
    new FileSystemLinkResolver<Void>() {
      @Override
      public Void doCall(final Path p) throws IOException {
  ...
  public void setQuotaByStorageType(Path src, final StorageType type,
      final long quota)
      throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {}, {})", src, type, quota);
    Path absF = fixRelativePart(src);
    new FileSystemLinkResolver<Void>() {
      @Override
      public Void doCall(final Path p) throws IOException {
  ...
  private FileStatus[] listStatusInternal(Path p) throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", p);
  ...
  protected RemoteIterator<LocatedFileStatus> listLocatedStatus(final Path p,
      ...
      throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", p, filter);
    Path absF = fixRelativePart(p);
  ...
  public boolean mkdir(Path f, FsPermission permission) throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", f, permission);
  ...
  private boolean mkdirsInternal(Path f, final FsPermission permission,
	...
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {}, {})", f, permission, createParent);
    statistics.incrementWriteOps(1);
  ...
  protected boolean primitiveMkdir(Path f, FsPermission absolutePermission)
      throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", f, absolutePermission);
    statistics.incrementWriteOps(1);
  ...
  public DatanodeInfo[] getDataNodeStats(final DatanodeReportType type)
      throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", type);
  ...
  public boolean setSafeMode(HdfsConstants.SafeModeAction action)
      throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", action);
  ...
  public boolean setSafeMode(HdfsConstants.SafeModeAction action,
	...
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", action, isChecked);
  ...
  public boolean restoreFailedStorage(String arg) throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", arg);
  ...
  public void metaSave(String pathname) throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", pathname);
  ...
  public void createSymlink(final Path target, final Path link,
      final boolean createParent) throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {}, {})", target, link, createParent);
  ...
  public FileChecksum getFileChecksum(Path f, final long length)
      throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", f, length);
    statistics.incrementReadOps(1);
    storageStatistics.incrementOpCounter(OpType.GET_FILE_CHECKSUM);
    Path absF = fixRelativePart(f);
    return new FileSystemLinkResolver<FileChecksum>() {
  ...
  public void setPermission(Path p, final FsPermission permission
	...
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", p, permission);
    statistics.incrementWriteOps(1);
  ...
  public void setOwner(Path p, final String username, final String groupname)
	...
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {}, {})", p, username, groupname);
    statistics.incrementWriteOps(1);
  ...
  public void setTimes(Path p, final long mtime, final long atime)
      throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {}, {})", p, mtime, atime);
    statistics.incrementWriteOps(1);
  ...
  public Token<DelegationTokenIdentifier> getDelegationToken(String renewer)
      throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", renewer);
  ...
  public void setBalancerBandwidth(long bandwidth) throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", bandwidth);
  ...
  protected URI canonicalizeUri(URI uri) {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", uri);
  ...
  public Path createSnapshot(final Path path, final String snapshotName)
      throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", path, snapshotName);
    statistics.incrementWriteOps(1);
  ...
  public void renameSnapshot(final Path path, final String snapshotOldName,
	...
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {}, {})", path, snapshotOldName, snapshotNewName);
    statistics.incrementWriteOps(1);
  ...
  public void deleteSnapshot(final Path snapshotDir, final String snapshotName)
      throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", snapshotDir, snapshotName);
    statistics.incrementWriteOps(1);
  ...
  public SnapshotDiffReport getSnapshotDiffReport(final Path snapshotDir,
	...
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {}, {})", snapshotDir, fromSnapshot, toSnapshot);
    Path absF = fixRelativePart(snapshotDir);
  ...
  public long addCacheDirective(CacheDirectiveInfo info) throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", info);
  ...
  public long addCacheDirective(
	...
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", info, flags);
  ...
  public void removeCacheDirective(long id)
      throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", id);
  ...
  public RemoteIterator<CacheDirectiveEntry> listCacheDirectives(
	...
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", filter);
    if (filter == null) {
  ...
  public void removeCachePool(String poolName) throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", poolName);
  ...
  public void modifyAclEntries(Path path, final List<AclEntry> aclSpec)
      throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", path, aclSpec);
    statistics.incrementWriteOps(1);
  ...
  public void createEncryptionZone(final Path path, final String keyName)
      throws IOException {
	LOG.info("HDFS: only " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", path, keyName);
    Path absF = fixRelativePart(path);
    new FileSystemLinkResolver<Void>() {
      @Override
      public Void doCall(final Path p) throws IOException {
  ...
  public EncryptionZone getEZForPath(final Path path)
      throws IOException {
	LOG.info("HDFS: only " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", path);
  ...
  public RemoteIterator<EncryptionZone> listEncryptionZones()
      throws IOException {
	LOG.info("HDFS: only " + Thread.currentThread().getStackTrace()[1].getMethodName()+"()");
  ...
  public void setXAttr(Path path, final String name, final byte[] value,
	...
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {}, {}, {})", path, name, value, flag);
    statistics.incrementWriteOps(1);
  ...
  public byte[] getXAttr(Path path, final String name) throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", path, name);
    statistics.incrementReadOps(1);
  ...
  public Map<String, byte[]> getXAttrs(Path path, final List<String> names)
      throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", path, names);
    final Path absF = fixRelativePart(path);
    return new FileSystemLinkResolver<Map<String, byte[]>>() {
      @Override
      public Map<String, byte[]> doCall(final Path p) throws IOException {
  ...
  public void access(Path path, final FsAction mode) throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", path, mode);
    final Path absF = fixRelativePart(path);
    new FileSystemLinkResolver<Void>() {
      @Override
      public Void doCall(final Path p) throws IOException {
  ...
  public Token<?>[] addDelegationTokens(
	...
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({}, {})", renewer, credentials);
  ...
  public DFSInotifyEventInputStream getInotifyEventStream(long lastReadTxid)
      throws IOException {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", lastReadTxid);
  ...
  public Collection<FileStatus> getTrashRoots(boolean allUsers) {
	LOG.info("HDFS: " + Thread.currentThread().getStackTrace()[1].getMethodName()+"({})", allUsers);
